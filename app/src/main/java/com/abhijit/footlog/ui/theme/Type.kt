...
val FootlogTypography = Typography(
    displayLarge = TextStyle(fontWeight = FontWeight.Medium, fontSize = 57.sp, lineHeight = 64.sp),
    displayMedium = TextStyle(fontWeight = FontWeight.Medium, fontSize = 45.sp, lineHeight = 52.sp),
    ...
    headlineMedium = TextStyle(fontWeight = FontWeight.Medium, fontSize = 28.sp, lineHeight = 36.sp),
